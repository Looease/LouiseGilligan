...
export const KblSolutions = () => {
    return (
        <main className="kblMain">
            <section className="kblBanner">
                <a href="#"><img src="img/kblSolutions/logo.png" alt="" className="kblLogo"></img></a>
          ...
          If you are interested in any of their services please contact them at <a href="mailto:info@kblsolutions.co.uk" id="black">info@kblsolutions.co.uk</a>
            ...
            <br></br>
            <br></br>
            <section className="kblContent">
                <div className="kblWrap">

                </div>
                <div id="container">
                    <img src="img/kblSolutions/2.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">A modern homepage</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/3.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">Javascript & jQuery Product Slider</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/1.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">Bespoke page design</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/15.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">Quick quote request form</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/16.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">Javascript thumbnail/colour select</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/8.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">Speech bubble testimonials</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/9.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">ROI driven design</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/4.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">Bespoke contact form</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/6.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">PDF downloads & footers</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/13.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">Responsive tablet design</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/14.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">Responsive mobile design</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/7.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">Collapsing mobile burger menu</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/10.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">Custom responsive backgrounds</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/12.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
                        <div id="text">Responsive tablet menu</div>
                    </div>
                </div>
                <div id="container">
                    <img src="img/kblSolutions/11.jpg" alt="Avatar" id="image"></img>
                    <div id="overlay">
